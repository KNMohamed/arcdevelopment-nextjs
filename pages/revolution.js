  ...
  return (
    <Grid container direction="column">
      ...
      >
        ...
        <Grid lg item container justify={matchesMD ? "center" : "flex-end"}>
          <Lottie
      ...
      >
        ...
        <Grid lg item style={{ alignSelf: "center" }}>
          <img
      ...
      >
        ...
        <Grid lg item style={{ alignSelf: "center" }}>
          <img
            ...
            style={{ maxWidth: matchesMD ? 700 : 1000, width: "100%" }}
          />
        </Grid>
      </Grid>
      <Grid
